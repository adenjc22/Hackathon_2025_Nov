...
from app.api.routes.ai_process import router as ai_process_router
...
app.include_router(ai_config_router, tags=["AI Configuration"])
app.include_router(ai_process_router, tags=["AI Processing"])
